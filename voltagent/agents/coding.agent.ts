...
import z from 'zod'
import { codingAgentGuardrails } from '../config/guardrails.js'
...
export const codingAgent = new Agent({
    ...
    summarization: {
        ...
        maxOutputTokens: 800,
        systemPrompt:
            'Summarize the coding conversation so far to preserve context.',
    },
    ...
    inputGuardrails: codingAgentGuardrails.input,
    outputGuardrails: codingAgentGuardrails.output,
    inputMiddlewares: [],
    outputMiddlewares: [],
